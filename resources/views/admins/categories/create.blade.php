        ...
        <div class="nk-content-body">
            <div class="buysell wide-xs m-auto">
                <div class="buysell-title text-center">
                    <h4 class="title">
                        Tambahkan kategori untuk setiap produk
                    </h4>
                </div><!-- .buysell-title -->
                <div class="buysell-block">
                    <form action="{{ route('admins.categories.store') }}" class="buysell-form" method="post">
                        @csrf
                        @method('post')
                        <div class="buysell-field form-group">
                            ...
                            <div class="form-control-group">
                                <input value="{{ old('name') }}" type="text" class="form-control form-control-lg form-control-number" id="name" name="name" placeholder="Judul postingan">
                            </div>
                            @error('name')
